...
let enquiryInsert=(req,res)=>
{
     ...
     enquiry.save().then(()=>{
      ...
      res.send({status:0, message:"Error while saving successfully",error:err});
     })
}
...
module.exports={enquiryInsert,enquiryList,enquirySingleRow, enquiryDelete,enquiryUpdate};